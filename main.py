...
def main():
    ...
    for x in listings:
        ...
        except Exception as e: print(f"[WARN] Telegram failed: {type(e).__name__}: {e}")
    save_seen(new_seen); print(f"[DONE] Checked {len(listings)} usable listings; {new_count} new URLs; {sent} alerts.")
